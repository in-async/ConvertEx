    ...
    public partial class ConvertExtraTest {
        ...
        public void MD5_Test() {
            foreach (var item in MD5_TestSource) {
                if (!AssertException.TryExecute(() => ConvertExtra.MD5(item.message, item.encoding), item.expectedExceptionType, out var actual)) {
                    continue;
                }
        ...
        private static IEnumerable<(string message, Encoding encoding, byte[] expected, Type expectedExceptionType)> MD5_TestSource = new(string, Encoding, byte[], Type)[]{
            ...
            ("foo" , null, ConvertExtra.FromHexString("acbd18db4cc2f85cedef654fccc4a4d8"), null),
            ("ほげ", null, ConvertExtra.FromHexString("63e6f3f3326ea60afe9f7b037cc1d732"), null),
            ("ほげ", UTF8, ConvertExtra.FromHexString("63e6f3f3326ea60afe9f7b037cc1d732"), null),
            ("ほげ", SJIS, ConvertExtra.FromHexString("9e6c4b30163d973d011f10143b25efd8"), null),
        };

        [TestMethod]
        public void SHA1_Test() {
            foreach (var item in SHA1_TestSource) {
                if (!AssertException.TryExecute(() => ConvertExtra.SHA1(item.message, item.encoding), item.expectedExceptionType, out var actual)) {
                    continue;
                }
        ...
        private static IEnumerable<(string message, Encoding encoding, byte[] expected, Type expectedExceptionType)> SHA1_TestSource = new(string, Encoding, byte[], Type)[]{
            ...
            ("foo" , null, ConvertExtra.FromHexString("0beec7b5ea3f0fdbc95d0dd47f3c5bc275da8a33"), null),
            ("ほげ", null, ConvertExtra.FromHexString("eb3a35081005182d70ff64c9856e14186c03e197"), null),
            ("ほげ", UTF8, ConvertExtra.FromHexString("eb3a35081005182d70ff64c9856e14186c03e197"), null),
            ("ほげ", SJIS, ConvertExtra.FromHexString("cba533c92ab3949601a520508faf080cc796aa4d"), null),
        };
    }
}